...
export default function UnifiedLayout() {
  ...
  // Use actual user profile photo or default avatar
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5">
            ...
            scale: 1.02
                ...
                {userProfilePhoto ? <img src={userProfilePhoto} alt={user?.name || 'User'} className="w-12 h-12 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg flex-shrink-0" /> : <div className="w-12 h-12 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center flex-shrink-0 shadow-lg">
            ...
            scale: 1.1
          }} className="w-12 h-12 mx-auto cursor-pointer" title={user?.name || 'User'}>
                {userProfilePhoto ? <img src={userProfilePhoto} alt={user?.name || 'User'} className="w-12 h-12 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg" /> : <div className="w-12 h-12 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center shadow-lg">
                    <UserIcon className="w-6 h-6 text-white" />
                  </div>}
              </motion.div>}
          </div>
      ...
      <AnimatePresence>
        {sidebarOpen && <>
          ...
          stiffness: 200
              ...
              {/* Mobile User Info with Profile Photo */}
              <div className="p-4 border-t border-m2m-divider">
                <div className="flex items-center space-x-3 px-4 py-3 bg-m2m-bg-primary rounded-lg">
                  {userProfilePhoto ? <img src={userProfilePhoto} alt={user?.name || 'User'} className="w-10 h-10 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg flex-shrink-0" /> : <div className="w-10 h-10 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center flex-shrink-0">
        ...
        <header className="bg-m2m-bg-card border-b border-m2m-divider sticky top-0 z-30 shadow-sm">
          <div className="flex items-center justify-between px-4 lg:px-6 py-4">
            ...
            <div className="flex items-center space-x-4">
              ...
              {/* User Menu Dropdown with Profile Photo */}
              <div className="relative">
                <motion.button whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
                  ...
                  <div className="relative">
                    {userProfilePhoto ? <img src={userProfilePhoto} alt={user?.name || 'User'} className="w-10 h-10 rounded-full object-cover border-2 border-m2m-divider group-hover:border-m2m-accent-blue transition-colors shadow-md" /> : <div className="w-10 h-10 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center border-2 border-m2m-divider group-hover:border-m2m-accent-blue transition-colors shadow-md">
                        <UserIcon className="w-5 h-5 text-white" />
                      </div>}
                  ...
                  {userMenuOpen && <>
                    ...
                    duration: 0.2
                        ...
                        <div className="px-4 py-3 border-b border-m2m-divider bg-gradient-to-r from-m2m-accent-blue/5 to-m2m-accent-teal/5">
                          <div className="flex items-center space-x-3">
                            {userProfilePhoto ? <img src={userProfilePhoto} alt={user?.name || 'User'} className="w-12 h-12 rounded-full object-cover border-2 border-m2m-accent-blue shadow-lg" /> : <div className="w-12 h-12 bg-gradient-to-br from-m2m-accent-blue to-m2m-accent-teal rounded-full flex items-center justify-center border-2 border-m2m-accent-blue shadow-lg">
                                <UserIcon className="w-6 h-6 text-white" />
                              </div>}
                            <div className="flex-1 min-w-0">
                              <p className="text-sm font-semibold text-m2m-text-primary truncate">
