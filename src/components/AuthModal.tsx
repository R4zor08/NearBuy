...
import { XIcon, EyeIcon, EyeOffIcon, ShieldCheckIcon, CheckCircleIcon, ArrowLeftIcon, MailIcon, CheckIcon, CameraIcon, UploadIcon } from 'lucide-react';
...
export default function AuthModal({
  ...
  // Remove 'admin' from account types for signup
  const accountTypes = mode === 'register' ? [{
    value: 'business',
    label: 'Business User'
  }, {
    value: 'supplier',
