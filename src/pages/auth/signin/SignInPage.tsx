...
import { EyeIcon, EyeOffIcon, ShieldCheckIcon, CheckCircleIcon, ArrowLeftIcon, MailIcon, LockIcon, SparklesIcon } from 'lucide-react';
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <AnimatePresence mode="wait">
            {!showForgotPassword ? <motion.div key="signin" initial={{
            opacity: 0,
            x: -20
          }} animate={{
            opacity: 1,
            ...
            duration: 0.3
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  })} className="w-full pl-10 pr-4 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="Enter your email" required />
                    </div>
                  </div>
                  ...
                  })} className="w-full pl-10 pr-12 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="Enter your password" required />
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center">
                      <input type="checkbox" id="rememberMe" checked={formData.rememberMe} onChange={e => setFormData({
                    ...formData,
                    rememberMe: e.target.checked
                  })} className="w-4 h-4 text-m2m-accent-blue border-m2m-divider rounded focus:ring-m2m-accent-blue" />
                      <label htmlFor="rememberMe" className="ml-2 text-sm text-m2m-text-secondary">
                        Remember me
                      </label>
                    </div>
                    <button type="button" onClick={() => setShowForgotPassword(true)} className="text-sm text-m2m-accent-blue hover:text-m2m-accent-teal transition-colors font-medium">
                      Forgot password?
                    </button>
                  </div>

                  <div className="flex items-start">
                    <input type="checkbox" id="acceptTerms" checked={formData.acceptTerms} onChange={e => setFormData({
                  ...formData,
                  acceptTerms: e.target.checked
                })} className="mt-0.5 w-4 h-4 text-m2m-accent-blue border-m2m-divider rounded focus:ring-m2m-accent-blue" />
                    <label htmlFor="acceptTerms" className="ml-2 text-sm text-m2m-text-secondary">
                      I accept the{' '}
                ...
                <div className="mt-6 text-center">
                  <p className="text-m2m-text-secondary text-sm">
                    ...
                    <Link to="/signup" className="text-m2m-accent-blue hover:text-m2m-accent-teal font-semibold transition-colors">
                      Sign Up
                    </Link>
                  </p>
                </div>
              ...
              </motion.div> : <motion.div key="forgot-password" initial={{
            opacity: 0,
            x: 20
          }} animate={{
            opacity: 1,
            ...
            duration: 0.3
                ...
                {!forgotPasswordSent ? <>
                    <button onClick={resetForgotPassword} className="mb-6 flex items-center text-m2m-accent-blue hover:text-m2m-accent-teal transition-colors">
                    ...
                    <form onSubmit={handleForgotPassword} className="space-y-4">
                      <div>
                        ...
                        <div className="relative">
                          <MailIcon className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-m2m-text-secondary" />
                          <input type="email" value={forgotPasswordEmail} onChange={e => setForgotPasswordEmail(e.target.value)} className="w-full pl-10 pr-4 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="Enter your email" required />
                        </div>
                      </div>

                      <button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white py-3 rounded-lg font-semibold hover:shadow-lg hover:brightness-110 transition-all disabled:opacity-50">
              ...
              opacity: 1
                    ...
                    <button onClick={resetForgotPassword} className="w-full bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white py-3 rounded-lg font-semibold hover:shadow-lg hover:brightness-110 transition-all">
                      Back to Sign In
                    </button>
                  </motion.div>}
              </motion.div>}
