...
import { EyeIcon, EyeOffIcon, ShieldCheckIcon, CheckCircleIcon, CheckIcon, CameraIcon, XIcon, MailIcon, LockIcon, UserIcon, SparklesIcon, TrendingUpIcon } from 'lucide-react';
...
export default function SignUpPage() {
  ...
  return <div className="min-h-screen bg-m2m-bg-primary flex">
          ...
          duration: 0.3
            ...
            <form onSubmit={handleRegister} className="space-y-4">
              <div>
                ...
                <div className="flex flex-col items-center">
                  {profilePhoto ? <div className="relative">
                      <img src={profilePhoto} alt="Profile Preview" className="w-24 h-24 rounded-full object-cover border-4 border-m2m-accent-blue shadow-lg" />
                      <button type="button" onClick={removePhoto} className="absolute -top-2 -right-2 w-8 h-8 bg-red-500 text-white rounded-full flex items-center justify-center hover:bg-red-600 transition-colors shadow-lg">
                        <XIcon className="w-4 h-4" />
                      </button>
                    </div> : <label className="w-24 h-24 bg-m2m-bg-card border-2 border-dashed border-m2m-divider rounded-full flex flex-col items-center justify-center cursor-pointer hover:border-m2m-accent-blue hover:bg-m2m-accent-blue/5 transition-all group">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  ...formData,
                  name: e.target.value
                })} className="w-full pl-10 pr-4 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="John Doe" required />
                </div>
              </div>
              ...
              <div>
                ...
                })} className="w-full pl-10 pr-4 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="john@example.com" required />
                </div>
              </div>
              ...
              <div>
                ...
                })} className="w-full pl-10 pr-12 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="Create a password" required />
                ...
                <div className="mt-2 space-y-1">
                  <div className="flex items-center text-xs">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center mr-2 transition-all ${formData.password.length >= 8 ? 'bg-m2m-success' : 'bg-gray-300'}`}>
                      {formData.password.length >= 8 && <CheckIcon className="w-3 h-3 text-white" />}
                    </div>
                  ...
                  <div className="flex items-center text-xs">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center mr-2 transition-all ${/[A-Z]/.test(formData.password) ? 'bg-m2m-success' : 'bg-gray-300'}`}>
                      {/[A-Z]/.test(formData.password) && <CheckIcon className="w-3 h-3 text-white" />}
                    </div>
                    <span className="text-m2m-text-secondary">
                  ...
                  <div className="flex items-center text-xs">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center mr-2 transition-all ${/[0-9]/.test(formData.password) ? 'bg-m2m-success' : 'bg-gray-300'}`}>
                      {/[0-9]/.test(formData.password) && <CheckIcon className="w-3 h-3 text-white" />}
                    </div>
              ...
              <div>
                ...
                })} className="w-full pl-10 pr-12 py-3 border-2 border-m2m-divider bg-m2m-bg-card text-m2m-text-primary rounded-lg focus:ring-2 focus:ring-m2m-accent-blue focus:border-transparent transition-all placeholder-m2m-text-secondary" placeholder="Confirm your password" required />
              ...
              <div>
                ...
                <select value={formData.accountType} onChange={e => setFormData({
                ...formData,
              ...
              <div className="flex items-start">
                <input type="checkbox" id="terms" checked={formData.agreeToTerms} onChange={e => setFormData({
                ...formData,
                agreeToTerms: e.target.checked
              })} className="mt-0.5 w-4 h-4 text-m2m-accent-blue border-m2m-divider rounded focus:ring-m2m-accent-blue" />
                <label htmlFor="terms" className="ml-2 text-sm text-m2m-text-secondary">
                  I agree to the{' '}
              ...
              <button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-m2m-accent-blue to-m2m-accent-teal text-white py-3 rounded-lg font-semibold hover:shadow-lg hover:brightness-110 transition-all disabled:opacity-50 flex items-center justify-center">
            ...
            <div className="mt-6 text-center">
              <p className="text-m2m-text-secondary text-sm">
                ...
                <Link to="/signin" className="text-m2m-accent-blue hover:text-m2m-accent-teal font-semibold transition-colors">
                  Sign In
                </Link>
              </p>
            </div>
