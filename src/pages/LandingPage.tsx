...
import { BrainIcon, BarChart3Icon, MapIcon, NetworkIcon, PlayCircleIcon, CheckCircleIcon, StarIcon, TrendingUpIcon, UsersIcon, TargetIcon, SparklesIcon, ZapIcon, BuildingIcon, HomeIcon, FactoryIcon, GraduationCapIcon, HeartPulseIcon, TreesIcon, AlertTriangleIcon, StoreIcon, MapPinIcon, XIcon, DollarSignIcon, PhoneIcon } from 'lucide-react';
...
export default function LandingPage() {
  ...
  const isValidLandCoordinate = (lat: number, lng: number): boolean => {
    ...
    if (lat < butuanLandBounds.south || lat > butuanLandBounds.north || lng < butuanLandBounds.west || lng > butuanLandBounds.east) {
      return false;
    }
    ...
    for (const zone of waterZones) {
      const distance = Math.sqrt(Math.pow(lat - zone.lat, 2) + Math.pow(lng - zone.lng, 2));
  ...
  const zones = [{
    ...
    type: 'commercial',
    coordinates: [[9.078, 126.192], [9.078, 126.198], [9.072, 126.198], [9.072, 126.192]] as [number, number][],
    color: '#1E90FF',
    icon: BuildingIcon,
    businesses: 245,
    growth: '+23%',
    ...
    characteristics: ['Prime retail locations', 'Banking and financial services', 'Government offices nearby', 'Public transportation access']
  }, {
    id: 2,
    name: 'Residential Zone',
    type: 'residential',
    coordinates: [[9.082, 126.188], [9.082, 126.194], [9.076, 126.194], [9.076, 126.188]] as [number, number][],
    color: '#36C275',
    icon: HomeIcon,
    businesses: 89,
    growth: '+15%',
    ...
    characteristics: ['Family-oriented neighborhoods', 'Local convenience stores', 'Schools and daycare centers', 'Community parks']
  }, {
    id: 3,
    name: 'Educational District',
    type: 'educational',
    coordinates: [[9.076, 126.194], [9.076, 126.2], [9.07, 126.2], [9.07, 126.194]] as [number, number][],
    color: '#00B3A4',
    ...
    characteristics: ['University campus', 'Secondary schools', 'Bookstores and supplies', 'Student housing']
  }, {
    id: 4,
    name: 'Industrial Zone',
    type: 'industrial',
    coordinates: [[9.068, 126.19], [9.068, 126.196], [9.062, 126.196], [9.062, 126.19]] as [number, number][],
    color: '#64748B',
    icon: FactoryIcon,
    businesses: 156,
    growth: '+20%',
    ...
    characteristics: ['Warehousing facilities', 'Manufacturing plants', 'Logistics and distribution', 'Port access']
  }, {
    id: 5,
    name: 'Recreational Area',
    type: 'recreational',
    coordinates: [[9.08, 126.2], [9.08, 126.206], [9.074, 126.206], [9.074, 126.2]] as [number, number][],
    color: '#A78BFA',
    icon: TreesIcon,
    businesses: 34,
    growth: '+8%',
    ...
    characteristics: ['Beach resorts', 'Parks and playgrounds', 'Sports facilities', 'Tourist attractions']
  }];
  ...
  const pricingPlans = [{
    ...
    features: ['Up to 5 location searches per month', 'Basic AI insights', 'Competitor heatmap access', 'Email support', 'Mobile app access', '1 user account'],
    gradient: 'from-m2m-neon-cyan to-m2m-electric-aqua',
    popular: false
  }, {
    id: 'professional',
    ...
    features: ['Unlimited location searches', 'Advanced AI analytics', 'Full competitor analysis', 'Priority support', 'API access', 'Up to 10 user accounts', 'Custom reports', 'Supplier network access'],
    gradient: 'from-m2m-neon-blue to-m2m-electric-aqua',
    popular: true
  }, {
    id: 'enterprise',
    ...
    features: ['Everything in Professional', 'Dedicated account manager', 'Custom AI model training', 'White-label options', 'Unlimited user accounts', 'SLA guarantees', 'Custom integrations', 'On-premise deployment option'],
    gradient: 'from-m2m-electric-aqua to-m2m-neon-cyan',
    popular: false
  }];
  ...
  const NearbySuppliersModal = () => <motion.div initial={{
    opacity: 0
  }} animate={{
    opacity: 1
  }} exit={{
    opacity: 0
  }} className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowSuppliersModal(false)}>
      <motion.div initial={{
      scale: 0.9,
      y: 20,
      opacity: 0
      ...
      stiffness: 300,
      damping: 30
    }} className="relative w-full max-w-2xl max-h-[85vh] overflow-hidden" onClick={e => e.stopPropagation()}>
        <div className="glass-panel-strong rounded-3xl p-8 border-2 border-m2m-success/40 shadow-premium-depth overflow-y-auto max-h-[85vh]">
          <div className="flex items-center justify-between mb-6">
            ...
            <motion.button onClick={() => setShowSuppliersModal(false)} className="p-2 hover:bg-m2m-success/10 rounded-lg transition-colors" whileHover={{
            scale: 1.1,
            rotate: 90
          }} whileTap={{
            scale: 0.9
          ...
          <div className="space-y-4">
            ...
            delay: index * 0.1
          }} className="glass-panel rounded-2xl p-6 border border-m2m-success/20 hover:border-m2m-success transition-all group" whileHover={{
            x: 8,
            scale: 1.02
          }}>
                <div className="flex items-start justify-between mb-4">
                  ...
                  <motion.div className="px-4 py-2 bg-m2m-success/20 rounded-full" animate={{
                scale: [1, 1.05, 1]
              }} transition={{
                duration: 2,
                repeat: Infinity
                ...
                <div className="flex items-center justify-between pt-3 border-t border-m2m-divider">
                  ...
                  <motion.button className="px-4 py-2 bg-m2m-success/20 hover:bg-m2m-success/30 text-m2m-success rounded-lg text-sm font-semibold transition-all" whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
              }}>
  ...
  const BusinessSuggestionsModal = () => <motion.div initial={{
    opacity: 0
  }} animate={{
    opacity: 1
  }} exit={{
    opacity: 0
  }} className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 backdrop-blur-sm" onClick={() => setShowBusinessSuggestions(false)}>
      <motion.div initial={{
      scale: 0.9,
      y: 20,
      opacity: 0
      ...
      stiffness: 300,
      damping: 30
    }} className="relative w-full max-w-4xl max-h-[85vh] overflow-hidden" onClick={e => e.stopPropagation()}>
        <div className="glass-panel-strong rounded-3xl p-8 border-2 border-m2m-neon-cyan/40 shadow-premium-depth overflow-y-auto max-h-[85vh]">
          <div className="flex items-center justify-between mb-6">
            ...
            <motion.button onClick={() => setShowBusinessSuggestions(false)} className="p-2 hover:bg-m2m-neon-cyan/10 rounded-lg transition-colors" whileHover={{
            scale: 1.1,
            rotate: 90
          }} whileTap={{
            scale: 0.9
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            delay: index * 0.1
          }} className="glass-panel rounded-2xl p-6 border border-m2m-divider hover:border-m2m-neon-cyan transition-all group" whileHover={{
            y: -8,
            scale: 1.02
          }}>
                <div className="flex items-start justify-between mb-4">
                  ...
                  <motion.div className="px-3 py-1 bg-m2m-success/20 rounded-full" animate={{
                scale: [1, 1.05, 1]
              }} transition={{
                duration: 2,
                repeat: Infinity
                ...
                <motion.button onClick={() => openAuthModal('register')} className="w-full py-3 btn-premium text-white rounded-xl font-semibold shadow-neon-glow-sm" whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }}>
  ...
  return <div className="w-full min-h-screen bg-m2m-bg-primary relative overflow-hidden">
          ...
          <div className="py-3 sm:py-4">
            <div className="hidden md:flex justify-between items-center">
              ...
              <div className="flex items-center space-x-6 lg:space-x-8">
                {['features', 'pricing', 'insights', 'contact'].map(item => <motion.a key={item} href={`#${item}`} className="text-m2m-text-secondary hover:text-m2m-neon-cyan transition-colors font-semibold relative group tracking-wide" style={{
                fontSize: '15px',
                letterSpacing: '0.5px'
              }} whileHover={{
                y: -2
                    ...
                    <motion.span className="absolute bottom-0 left-0 h-0.5 bg-gradient-to-r from-m2m-neon-cyan to-m2m-electric-aqua" initial={{
                  width: 0
                }} whileHover={{
                  width: '100%'
                }} transition={{
      ...
      <section className="pt-32 pb-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        background: ['radial-gradient(circle at 20% 50%, rgba(0, 255, 255, 0.15) 0%, transparent 50%)', 'radial-gradient(circle at 80% 50%, rgba(0, 102, 255, 0.15) 0%, transparent 50%)', 'radial-gradient(circle at 50% 80%, rgba(0, 217, 255, 0.15) 0%, transparent 50%)', 'radial-gradient(circle at 20% 50%, rgba(0, 255, 255, 0.15) 0%, transparent 50%)']
      }} transition={{
        duration: 15,
        repeat: Infinity,
        ease: 'linear'
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center">
            ...
            delay: 0.3
              ...
              <motion.span className="inline-block bg-gradient-to-r from-m2m-neon-cyan via-m2m-electric-aqua to-m2m-neon-blue bg-clip-text text-transparent" animate={{
              y: [0, -8, 0],
            ...
            delay: 0.4
              ...
              <span className="font-semibold bg-gradient-to-r from-m2m-neon-cyan via-m2m-electric-aqua to-m2m-neon-blue bg-clip-text text-transparent animate-gradient-flow" style={{
              backgroundSize: '200% 200%'
            }}>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            ...
            duration: 0.8
              ...
              stiffness: 300
                ...
                <div className="mini-map-container mb-4 h-48 relative">
                  ...
                  <MapContainer center={TANDAG_CITY_CENTER} zoom={14} scrollWheelZoom={false} zoomControl={false} dragging={false} style={{
                  height: '100%',
                  width: '100%',
                  borderRadius: '12px'
                }}>
                ...
                <div className="relative z-10">
                  ...
                  <motion.button onClick={() => setShowBusinessSuggestions(true)} className="w-full px-6 py-3 mb-4 glass-panel rounded-xl font-semibold transition-all border-2 border-m2m-neon-cyan/30 hover:border-m2m-neon-cyan hover:bg-m2m-neon-cyan/10 text-m2m-neon-cyan shadow-neon-glow-sm" whileHover={{
                  scale: 1.05,
                  y: -2
                }} whileTap={{
                  scale: 0.95
            ...
            duration: 0.8,
            delay: 0.2
          }} className="lg:col-span-3 glass-panel-strong rounded-2xl p-6 glow-border-animated shadow-premium-depth relative group" whileHover={{
            scale: 1.01
          }}>
              ...
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-4 flex-wrap gap-4">
                  ...
                  }} className="px-4 py-2 glass-panel rounded-lg text-sm font-semibold text-m2m-success hover:bg-m2m-success/10 transition-all flex items-center gap-2 border border-m2m-success/30 hover:border-m2m-success" whileHover={{
                    scale: 1.05,
                    y: -2
                  }} whileTap={{
                    scale: 0.95
                  ...
                  }} className="px-4 py-2 glass-panel rounded-lg text-sm font-semibold text-m2m-neon-cyan hover:bg-m2m-neon-cyan/10 transition-all flex items-center gap-2 border border-m2m-neon-cyan/30 hover:border-m2m-neon-cyan" whileHover={{
                    scale: 1.05,
                    y: -2
                  }} whileTap={{
                    scale: 0.95
                ...
                <div className="relative">
                  <div className="h-[700px] rounded-xl overflow-hidden border-2 border-m2m-neon-cyan/30 relative shadow-premium-depth">
                    <MapContainer center={TANDAG_CITY_CENTER} zoom={14} scrollWheelZoom={true} zoomControl={true} style={{
                    height: '100%',
                    width: '100%'
                      ...
                      {zones.map(zone => {
                      const ZoneIcon = zone.icon;
                      return <Polygon key={zone.id} positions={zone.coordinates} pathOptions={{
                        color: zone.color,
                        fillColor: zone.color,
                              ...
                              <div className="p-4 min-w-[280px]">
                                ...
                                <div className="border-t border-gray-200 pt-3">
                                  ...
                                  <ul className="space-y-1">
                                    {zone.characteristics.map((char, idx) => <li key={idx} className="text-xs text-gray-600 flex items-start">
                                        <CheckCircleIcon className="w-3 h-3 mr-1 mt-0.5 flex-shrink-0" style={{
                                    color: zone.color
                                  }} />
                                        <span>{char}</span>
                                      </li>)}
                      ...
                      {businessSuggestions.map(business => <Marker key={business.id} position={business.position} icon={createCustomIcon('#F89C36')}>
                          <Popup>
                            <div className="p-2">
                    ...
                    {/* Hover Info Panel */}
                    <AnimatePresence>
                      {hoveredZone !== null && <motion.div initial={{
                      opacity: 0,
                      x: 20
                    }} animate={{
                      opacity: 1,
                      ...
                      x: 20
                        ...
                        return <>
                              ...
                              border: `2px solid ${zone.color}`
                                    ...
                                    <ZoneIcon className="w-4 h-4" style={{
                                color: zone.color
                              }} />
                                  </div>
                ...
                pointerEvents: showBusinessPanel ? 'auto' : 'none'
                  ...
                  <div className="space-y-3 overflow-y-auto max-h-[calc(100%-60px)] pr-2">
                    ...
                    delay: index * 0.1
                  }} className="glass-panel rounded-lg p-4 hover-lift cursor-pointer border border-m2m-success/20" whileHover={{
                    scale: 1.02
                  }}>
                        <div className="flex items-start justify-between mb-2">
                          ...
                          <motion.div className="px-2 py-1 bg-m2m-success/20 rounded-full" animate={{
                        scale: [1, 1.05, 1]
                      }} transition={{
                        duration: 2,
                        repeat: Infinity
              ...
              <div className="grid grid-cols-4 gap-4 mt-6">
                ...
                return <motion.div key={index} initial={{
                  ...
                  y: -4
                      ...
                      <StatIcon className={`w-6 h-6 mx-auto mb-2 ${stat.color} group-hover:scale-110 transition-transform`} />
      ...
      <section id="features" className="py-20 px-4 sm:px-6 lg:px-8 bg-m2m-bg-primary relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          delay: index * 0.1,
          duration: 0.6
        }} className="glass-panel rounded-2xl shadow-floating p-6 border border-m2m-divider hover:border-m2m-neon-cyan transition-all cursor-pointer group" whileHover={{
          y: -8,
          scale: 1.02
        }}>
            ...
            duration: 0.6
              ...
              <motion.button onClick={() => openAuthModal('register')} className="mt-4 text-sm text-m2m-neon-cyan hover:text-m2m-electric-aqua transition-colors flex items-center gap-2 opacity-0 group-hover:opacity-100" whileHover={{
            x: 5
          }}>
                Try it now
      ...
      <section id="pricing" className="py-20 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <motion.div className="absolute inset-0" animate={{
        background: ['linear-gradient(135deg, rgba(0, 255, 255, 0.05) 0%, rgba(0, 102, 255, 0.05) 50%, rgba(0, 217, 255, 0.05) 100%)', 'linear-gradient(225deg, rgba(0, 217, 255, 0.05) 0%, rgba(0, 102, 255, 0.05) 50%, rgba(0, 255, 255, 0.05) 100%)', 'linear-gradient(135deg, rgba(0, 255, 255, 0.05) 0%, rgba(0, 102, 255, 0.05) 50%, rgba(0, 217, 255, 0.05) 100%)']
      }} transition={{
        duration: 8,
        repeat: Infinity,
        ease: 'linear'
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          once: true
            ...
            <motion.div className="inline-flex items-center gap-2 px-6 py-3 glass-panel-strong rounded-full mb-6 shadow-neon-glow-sm" whileHover={{
            scale: 1.05
          }}>
              <SparklesIcon className="w-4 h-4 text-m2m-neon-cyan animate-pulse" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-16">
            {pricingPlans.map((plan, index) => <motion.div key={plan.id} initial={{
            opacity: 0,
            y: 50
          }} whileInView={{
            opacity: 1,
            ...
            delay: index * 0.1
          }} className={`glass-panel-strong rounded-2xl p-8 border-2 transition-all cursor-pointer relative overflow-hidden group min-h-[680px] flex flex-col ${selectedPlan === plan.id ? 'border-m2m-neon-cyan shadow-neon-glow' : 'border-m2m-divider hover:border-m2m-neon-cyan/50'} ${plan.popular ? 'md:-mt-4 md:mb-4' : ''}`} onClick={() => setSelectedPlan(plan.id as any)} whileHover={{
            y: -12,
            scale: 1.02,
            boxShadow: '0 20px 60px rgba(0, 217, 255, 0.3)'
              ...
              background: `linear-gradient(135deg, ${plan.id === 'starter' ? 'rgba(0, 217, 255, 0.05)' : plan.id === 'professional' ? 'rgba(0, 102, 255, 0.08)' : 'rgba(0, 255, 245, 0.05)'}, transparent)`
                ...
                <motion.div className="absolute inset-0 opacity-0 group-hover:opacity-100" animate={{
              ...
              backgroundSize: '200% 200%'
                ...
                {plan.popular && <motion.div className="absolute top-0 left-0 right-0 bg-gradient-to-r from-m2m-neon-cyan to-m2m-electric-aqua text-white text-xs font-bold py-2 text-center" animate={{
              opacity: [0.8, 1, 0.8],
              ...
              repeat: Infinity
                ...
                <div className={`flex flex-col flex-1 ${plan.popular ? 'mt-8' : ''}`}>
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-2xl font-bold text-m2m-text-primary">
                      {plan.name}
                    </h3>
                    {selectedPlan === plan.id && <motion.div initial={{
                  scale: 0
                }} animate={{
                  scale: 1
              ...
              }} className={`w-full py-4 rounded-xl font-semibold transition-all mb-6 relative z-10 ${plan.popular ? 'btn-premium text-white shadow-neon-glow' : 'glass-panel text-m2m-neon-cyan hover:bg-m2m-neon-cyan/10 border-2 border-m2m-neon-cyan/30'}`} whileHover={{
                scale: 1.05
              }} whileTap={{
                scale: 0.95
              }}>
                  ...
                  <div className="space-y-3 flex-1">
                    {plan.features.map((feature, i) => <motion.div key={i} initial={{
                  opacity: 0,
                  x: -20
                }} whileInView={{
                  opacity: 1,
          ...
          once: true
            ...
            <div className="relative glass-panel-strong rounded-3xl p-12 border-2 border-m2m-neon-cyan/30 shadow-premium-depth overflow-hidden">
              <div className="absolute inset-0 overflow-hidden pointer-events-none">
                {[...Array(15)].map((_, i) => <motion.div key={i} className="absolute w-2 h-2 bg-m2m-neon-cyan/40 rounded-full" initial={{
                x: Math.random() * 100 + '%',
                y: '100%'
              }} animate={{
                y: '-100%',
              ...
              <div className="text-center relative z-10">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-8">
                  <motion.button onClick={() => openAuthModal('register')} className="px-10 py-5 btn-premium text-white rounded-xl font-bold text-lg shadow-neon-glow" whileHover={{
                  scale: 1.05
                }} whileTap={{
                  scale: 0.95
                }}>
                  ...
                  <motion.button className="px-10 py-5 glass-panel text-m2m-text-primary rounded-xl font-semibold text-lg border-2 border-m2m-neon-cyan/30 hover:border-m2m-neon-cyan/60 transition-all" whileHover={{
                  scale: 1.05
                }} whileTap={{
                  scale: 0.95
                }}>
      ...
      {/* Contact Section */}
      <section id="contact" className="py-20 px-4 sm:px-6 lg:px-8 bg-m2m-bg-primary relative overflow-hidden">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{
          opacity: 0,
          y: 30
            ...
            once: true
              ...
              <form onSubmit={handleContactSubmit} className="space-y-6">
                <div>
                  ...
                  ...contactForm,
                  name: e.target.value
                })} className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary focus:outline-none focus:border-m2m-neon-cyan focus:ring-2 focus:ring-m2m-neon-cyan/20 transition-all" placeholder="John Doe" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-m2m-text-primary mb-2">
                    Email Address *
                ...
                })} className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary focus:outline-none focus:border-m2m-neon-cyan focus:ring-2 focus:ring-m2m-neon-cyan/20 transition-all" placeholder="john@example.com" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-m2m-text-primary mb-2">
                    Company Name
                  </label>
                  <input type="text" value={contactForm.company} onChange={e => setContactForm({
                  ...contactForm,
                  company: e.target.value
                })} className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary focus:outline-none focus:border-m2m-neon-cyan focus:ring-2 focus:ring-m2m-neon-cyan/20 transition-all" placeholder="Your Company" />
                </div>
                <div>
                  <label className="block text-sm font-medium text-m2m-text-primary mb-2">
                    Message *
                ...
                })} className="w-full px-4 py-3 bg-m2m-bg-primary border border-m2m-divider rounded-xl text-m2m-text-primary focus:outline-none focus:border-m2m-neon-cyan focus:ring-2 focus:ring-m2m-neon-cyan/20 transition-all resize-none" placeholder="Tell us about your project..." />
                </div>
                <motion.button type="submit" className="w-full py-4 btn-premium text-white rounded-xl font-semibold shadow-neon-glow-sm" whileHover={{
                scale: 1.02
              }} whileTap={{
                scale: 0.98
              }}>
